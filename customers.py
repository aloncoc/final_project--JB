...
class Customer(Base):
    ...
    user_id = Column(BigInteger(), ForeignKey('users.id', ondelete='CASCADE'), unique=True, nullable=True)
    users = relationship('User', backref=backref('customers', uselist=True, passive_deletes=True))
